...
gc_plot <- ggplot(final_gc) + 
  geom_line(aes(x = Time, y = .data[["0ugmL_SIgA"]], col = "0ugmL_SIgA")) + 
  geom_line(aes(x = Time, y = .data[["30ugmL_SIgA"]], col = "30ugmL_SIgA")) + 
  geom_line(aes(x = Time, y = .data[["300ugmL_SIgA"]], col = "300ugmL_SIgA")) + 
  labs(x = "Time (min)", y = "OD", col = "Conditions") + 
  theme_tufte()
